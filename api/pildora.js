...
export default async function handler(req,res){
  ...
  try{
    ...
    res.status(200).json({intent,intro:INTRO[intent]||'Hay más de una forma de mirar esta situación. La app te propone pruebas concretas para descubrir qué te resulta útil.',food,activity});
