// lib/motor-insights.js
// Motor de Correlación (puro): cruza "registro_diario_real" (comidas/bloqueos) con
// "bienestar_diario_real" (energía/ánimo/sueño/digestión) para un usuario,
// y genera frases de insight en lenguaje simple.
//
// Este módulo NO conoce nivel de acceso, lógica Premium, ni el objeto de respuesta HTTP.
// Solo calcula y persiste el resultado. Quién puede verlo es decisión de la capa de acceso.
//
// Reglas confirmadas (sin modificar — Sprint 16 no autoriza tocar umbrales):
...
// eso es responsabilidad de quien llame a esta función.
...
// Persiste el resultado calculado en "insights_generados" y lo devuelve como dato.
// No responde HTTP — eso es responsabilidad exclusiva del endpoint que llama a esta función.
...
module.exports = { calcularInsights };
